...
import { WH_RACK_PROVIDER } from './wh-rack.provider';
import { WhRackTestService } from './wh-rack-test.service'
...
describe('WH_RACK', () => {
    ...
    let whRackTestService: WhRackTestService
    ...
    beforeAll(async () => {
        ...
        whRackTestService = app.get<WhRackTestService>(WhRackTestService);
    ...
    describe('WH_RACK <test case group description>', () => {
